...
Full actor-by-actor analysis: [`PRIVACY.md`](./stealthtag/PRIVACY.md). Key handling: [`SECURITY.md`](./stealthtag/SECURITY.md).
...
> **Everything below runs from the app directory:**
> ```bash
> cd stealthtag
> ```
